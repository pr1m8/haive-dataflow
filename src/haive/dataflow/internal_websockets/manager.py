...
class ConnectionManager:
    ...
    async def connect(self, websocket: WebSocket, thread_id: str) -> Optional[str]:
        """
    ...
    def disconnect(self, thread_id: str, connection_id: str) -> None:
        ...
        """
        # Remove connection
        if thread_id in self.active_connections and connection_id in self.active_connections[thread_id]:
            # Get user_id
