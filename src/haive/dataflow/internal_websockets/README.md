...
```python
from haive.internal_websockets import module_function
...
For detailed API documentation, see the [API Reference](../../../docs/source/api/internal_websockets/index.rst).
