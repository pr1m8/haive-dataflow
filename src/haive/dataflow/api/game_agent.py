...
class AgentManager:
    ...
    def get_or_create_agent(self, thread_id: str, config_overrides: dict[str, Any] | None = None) -> Any:
    ...
    def _register_routes(self):
        ...
        async def create_agent(request: AgentRequest):
            ...
            try:
                ...
                elif self.state_schema and hasattr(self.state_schema, "initialize") and callable(self.state_schema.initialize):
        ...
        async def run_agent(thread_id: str, input_data: dict[str, Any]):
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Error running agent: {e!s}")
        ...
        async def get_agent_state(thread_id: str):
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Error getting agent state: {e!s}")
        ...
        async def get_threads():
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Error getting threads: {e!s}")
        ...
        async def get_thread_checkpoints(thread_id: str):
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Error getting checkpoints: {e!s}")
