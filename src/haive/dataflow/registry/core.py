...
class RegistrySystem:
        ...
        if self._supabase is not None:
            try:
                ...
                try:
                    ...
                    if (hasattr(e, "code") and e.code == "42P01") or str(e).find("does not exist") >= 0:
    ...
    def get_environment_vars(self, provider_name: str | None = None) -> list[dict[str, Any]]:
    ...
    def get_available_providers(self, entity_type: EntityType | None = None) -> list[dict[str, Any]]:
