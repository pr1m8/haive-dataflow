...
def run_migrate():
    ...
    try:
        from haive.dataflow.utils.vault_migration_script import migrate_env_vars_to_vault, migrate_component_env_mappings, \
...
def run_import(model_type=None, skip_llm=False, skip_embeddings=False, no_progress=False):
    ...
    try:
        from haive.dataflow.importers.litellm_importer import import_llm_models, import_embedding_models, update_availability_status
...
def run_verify():
    ...
    try:
        from haive.dataflow.utils.vault_migration_script import generate_report
