...
try:
    from haive.dataflow.supabase.base import get_supabase_client
...
class RegistryDB:
    ...
    def get_schema_definitions(self, registry_item_id: str, schema_type: str | None = None) -> list[SchemaDefinition]:
