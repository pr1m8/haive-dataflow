...
class SupabaseConfig(BaseModel):
    ...
    jwt_secret: str | None = Field(None, description="JWT secret for token verification")
    ...
    def verify_token(self, token: str) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                raise ValueError(f"Invalid token: {jwt_error!s} (original error: {e!s})")
...
def get_supabase_client(config: SupabaseConfig | None = None) -> SupabaseClient:
