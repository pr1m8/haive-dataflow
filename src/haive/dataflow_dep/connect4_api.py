...
from src.api.api.game_agent import AgentResponseBase, GenericAgentAPI
...
class Connect4MoveRequest(BaseModel):
    ...
    explanation: str | None = Field(None, description="Optional explanation for the move")
    ...
    def _register_connect4_routes(self):
        ...
        async def create_game(request: Connect4Request):
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Error creating Connect4 game: {e!s}")
        ...
        async def make_move(thread_id: str, move: Connect4MoveRequest):
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Error making Connect4 move: {e!s}")
        ...
        async def make_ai_move(thread_id: str):
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Error making AI move: {e!s}")
        ...
        async def get_game(thread_id: str):
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Error getting Connect4 game: {e!s}")
        ...
        async def list_games():
            ...
            try:
                ...
                raise HTTPException(status_code=500, detail=f"Error listing Connect4 games: {e!s}")
