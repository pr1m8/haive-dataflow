...
try:
    ...
    from haive_dataflow.registry.models import EntityType, ImportStatus
    from haive_dataflow.registry.discovery import discover_all, discover_agents, discover_tools, discover_toolkits, discover_engines, discover_games
