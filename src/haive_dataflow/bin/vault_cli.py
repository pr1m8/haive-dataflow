...
def execute_sql(sql: str) -> Any:
    ...
    try:
        ...
        try:
            from haive_dataflow.db.supabase import sanitize_sql, get_supabase_client
            ...
            from haive_dataflow.db.supabase import get_supabase_client
...
def ensure_vault_reference_column(table_name: str) -> bool:
    ...
    """
    try:
        from haive_dataflow.db.supabase import get_supabase_client, table, sanitize_sql
        supabase = get_supabase_client()
...
def add_columns(args):
    ...
    try:
        from haive_dataflow.db.supabase import get_supabase_client, sanitize_sql
        supabase = get_supabase_client()
    except ImportError:
