...
class SupabasePersistenceIntegration:
    ...
    def __init__(self):
        ...
        if PERSISTENCE_AVAILABLE:
            try:
                self.persistence_manager = PersistenceManager.from_env()
                logger.info("PersistenceManager initialized from environment variables")
    ...
    def register_thread(self, thread_id: str, user_info: Optional[Dict[str, Any]] = None) -> bool:
        """
