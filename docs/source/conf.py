...
autoapi_dirs = ["../../src/haive/dataflow"]
autoapi_type = "python"
...
html_theme_options = {
    ...
    "announcement": (
        ...
        '🚀 <a href="https://github.com/pr1m8/haive-dataflow" target="_blank">Star us on GitHub</a> | '
    ...
    "source_repository": "https://github.com/pr1m8/haive-dataflow",
    "source_branch": "main",
