...
.. toggle:: Show Inheritance Diagram
   ...
   Inheritance diagram for LazyRegistryAccess:

   .. graphviz::
      :align: center

      digraph inheritance_LazyRegistryAccess {
        node [shape=record];
        "LazyRegistryAccess" [label="LazyRegistryAccess"];
      }

.. autoclass:: dataflow.LazyRegistryAccess
   :members:
   :undoc-members:
   :show-inheritance:
